...
class ForwardSurfzoneRunner:
    ...
    Unlike backward tracing (per-point), forward tracing shoots rays from
    the boundary and deposits energy as they propagate. This naturally
    captures wave focusing effects.
...
def run_forward_surfzone_simulation(
    ...
    Args:
        ...
        rays_per_point: Number of rays at each boundary point
    ...
    config = ForwardTracerConfig(
        ...
        rays_per_boundary_point=rays_per_point,
